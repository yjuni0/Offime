...
//
//    // 휴가 메시지 발행
//    public void sendVacationMessage(String routingKey, NotificationMessage notificationMessage) {
//        rabbitTemplate.convertAndSend(RabbitConfig.VACATION_EXCHANGE, routingKey, notificationMessage);
//    }
//    public void sendVacationApprovedMessage(String routingKey, NotificationMessage notificationMessage) {
//        rabbitTemplate.convertAndSend(RabbitConfig.VACATION_EXCHANGE, routingKey, notificationMessage);
//    }
//    public void sendVacationRejectedMessage(String routingKey, NotificationMessage notificationMessage) {
//        rabbitTemplate.convertAndSend(RabbitConfig.VACATION_EXCHANGE, routingKey, notificationMessage);
//    }
//
//    // 비용 메시지 발행
