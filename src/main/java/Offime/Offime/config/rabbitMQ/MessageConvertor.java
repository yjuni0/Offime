...
//
//    // 휴가 신청 메시지 생성
//    public static String convertApplyVacationMessage(Long memberId, ReqVacation reqVacation, MemberRepository memberRepository) {
//        Member member = memberRepository.findById(memberId)
//                .orElseThrow(() -> new MemberException("해당 멤버가 없습니다.", HttpStatus.BAD_REQUEST)); // 예외 처리
//
